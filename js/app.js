(() => {
    ...
    function initSliders() {
        if (document.querySelector(".furniture__slider")) new core(".furniture__slider", {
        ...
        const bulletName = [ "modern chair", "artek stool", "table", "wardrobe" ];
        if (document.querySelector(".fuatured__slider")) new core(".fuatured__slider", {
            ...
            loop: true,
            pagination: {
                el: ".top-fuatured__paggination",
                clickable: true,
                bulletClass: "top-fuatured__paginaion-bullet",
                bulletActiveClass: "top-fuatured__paginaion-active",
                renderBullet: function(index, className) {
                    return '<span class="' + className + '">' + bulletName[index] + "</span>";
                }
            },
            navigation: {
                prevEl: ".top-fuatured__arrows-prev",
                nextEl: ".top-fuatured__arrows-next"
            },
            on: {}
        });
        if (document.querySelector(".customer__slider")) new core(".customer__slider", {
            ...
            pagination: {
                el: ".customer__slider-paggination",
                clickable: true,
                bulletClass: "customer__slider-paginaion-bullet",
                bulletActiveClass: "customer__slider-paginaion-active",
                dynamicMainBullets: "1"
            },
            navigation: {
                prevEl: ".customer__slider-arrows-prev",
                nextEl: ".customer__slider-arrows-next"
            },
            on: {
                init: function(swiper) {
                    const allSlides = document.querySelector(".customer__navigation-number-all");
                    const allSlidesItems = document.querySelectorAll(".customer__slide:not(.swiper-slide-duplicate)");
                    allSlides.innerHTML = allSlidesItems.length < 10 ? `0${allSlidesItems.length}` : allSlidesItems.length;
                },
                slideChange: function(swiper) {
                    const currentSlide = document.querySelector(".customer__navigation-number-active");
    ...
    !function(t, e) {
        ...
        return function(t) {
            ...
            var r = n(1), i = n(2), o = n(3), u = n(19), c = n(20), f = function(t, e, n) {
                ...
                d && (n = e);
                for (a in n) s = !h && m && void 0 !== m[a], l = (s ? m : n)[a], p = _ && s ? c(l, r) : y && "function" == typeof l ? c(Function.call, l) : l, 
                m && u(m, a, l, t & f.U), g[a] != l && o(g, a, p), y && x[a] != l && (x[a] = l);
            };
            r.core = i, f.F = 1, f.G = 2, f.S = 4, f.P = 8, f.B = 16, f.W = 32, f.U = 64, f.R = 128, 
            t.exports = f;
        }, function(t, e) {
            t.exports = function(t) {
                try {
            ...
            n(2).inspectSource = function(t) {
                ...
                a && (o(n, "name") || i(n, "name", e)), t[e] !== n && (a && (o(n, u) || i(n, u, t[e] ? "" + t[e] : f.join(String(e)))), 
            ...
            t.exports = function(t, e, n, d, v, y, _) {
                ...
                if (T && (x = s(T.call(new t))) !== Object.prototype && x.next && (a(x, O, !0), 
                r || "function" == typeof x[l] || u(x, l, h)), w && S && "values" !== S.name && (j = !0, 
                P = function() {
                    return S.call(this);
                }), r && !_ || !p && !j && M[l] || u(M, l, P), c[e] = P, c[O] = h, v) if (m = {
                    values: w ? P : b("values"),
                    keys: y ? P : b("keys"),
                    entries: A
                }, _) for (g in m) g in M || o(M, g, m[g]); else i(i.P + i.F * (p || j), e, m);
                return m;
            };
        }, function(t, e, n) {
            ...
            var r = n(5), i = n(39), o = n(25), u = n(14)("IE_PROTO"), c = function() {}, f = function() {
                ...
                for (e.style.display = "none", n(45).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, 
                t.open(), t.write("<script>document.F=Object<\/script>"), t.close(), f = t.F; r--; ) delete f.prototype[o[r]];
                return f();
            };
            t.exports = Object.create || function(t, e) {
                var n;
                return null !== t ? (c.prototype = r(t), n = new c, c.prototype = null, n[u] = t) : n = f(), 
                void 0 === e ? n : i(n, e);
            };
        }, function(t, e, n) {
            ...
            i(i.S + i.F * !n(53)((function(t) {
                ...
                from: function(t) {
                    ...
                    if (y && (v = r(v, d > 2 ? arguments[2] : void 0, 2)), void 0 == m || h == Array && c(m)) for (e = f(p.length), 
                    n = new h(e); e > _; _++) a(n, _, y ? v(p[_], _) : p[_]); else for (l = m.call(p), 
                    n = new h; !(i = l.next()).done; _++) a(n, _, y ? u(l, v, [ i.value, _ ], !0) : i.value);
                    return n.length = _, n;
                }
            });
        }, function(t, e, n) {
            ...
            var o = function() {
                ...
                function t(e, n) {
                    ...
                    r.setAttribute("aria-label", e.innerText), r.style.position = "relative", this.container = r, 
                    this._letters = (0, a.default)(e, n), this._letters.forEach((function(t) {
                    ...
                    this._fontSize = parseFloat(f), this._lineHeight = parseFloat(s) || this._fontSize, 
                    this._metrics = this._letters.map(c.default);
                    var l = this._metrics.reduce((function(t, e) {
                        return t + e.width;
                    }), 0);
                    this._minRadius = l / y / 2 + this._lineHeight, this._dir = 1, this._forceWidth = !1, 
                    this._forceHeight = !0, this._radius = this._minRadius, this._invalidate();
                }
                return o(t, [ {
                    key: "radius",
                    value: function(t) {
                        return void 0 !== t ? (this._radius = _(this._minRadius, t), this._invalidate(), 
                        this) : this._radius;
                    }
                }, {
                    key: "dir",
                    ...
                    key: "_layout",
                    value: function() {
                        var t = this, e = this._radius, n = this._dir, r = -1 === n ? -e + this._lineHeight : e, i = "center " + r / this._fontSize + "em", o = e - this._lineHeight, u = (0, 
                        v.default)(this._metrics, o), c = u.rotations, f = u.θ;
                        if (this._letters.forEach((function(e, r) {
                            var o = e.style, u = (-.5 * f + c[r]) * n, a = -.5 * t._metrics[r].width / t._fontSize, s = "translateX(" + a + "em) rotate(" + u + "deg)";
                            o.position = "absolute", o.bottom = -1 === n ? 0 : "auto", o.left = "50%", o.transform = s, 
                            o.transformOrigin = i, o.webkitTransform = s, o.webkitTransformOrigin = i;
                        })), this._forceHeight) {
    ...
    da.init();
    const circleType = new CircleType(document.querySelector(".images-choose__text"));
    circleType.radius(0).dir(1);
    window["FLS"] = true;
    isWebp();
    menuInit();
    formRating();
